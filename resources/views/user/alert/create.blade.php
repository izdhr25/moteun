    ...
    <form action="{{ route('alert.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select type="text" class="form-control" name="name">
                ...
                <option value="{{ $tani->name }}">{{ $tani->id }} - {{ $tani->name }} - {{ $tani->kelamin }} - {{ $tani->umur }}</option>
                @endforeach

                @foreach($ternaks as $ternak)
                <option value="{{ $ternak->name }}">{{ $ternak->id }} - {{ $ternak->name }} - {{ $ternak->kelamin }} - {{ $ternak->umur }}</option>
                @endforeach
            </select>
        </div>
        @error('name')
        ...
        <div class="form-group">
            ...
            <textarea class="form-control ckeditor" id="content" name="keterangan" placeholder="Keterangan"></textarea>
        </div>
        @error('keterangan')
            <small style="color: red">{{ $message }}</small>
        @enderror
