...
@section('content')
    ...
    <div class="container-fluid mt-3 mb-5">
      @if(!empty($notification))
        ...
        <strong>Pemberitahuan!</strong> {{ $notifications->name }} dengan id {{ $notifications->name_id }} berjenis {{ $notifications->jenis }} dan berkelamin {{ $notifications->kelamin }} telah siap dikembangbiakan.
      </div>
        @endforeach
      <div class="d-flex">
          {{ $notification->links() }}
