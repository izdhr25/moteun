    ...
    <form action="{{ route('ternak.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
           <label for="">Kegunaan Hewan</label>
            <input type="text" class="form-control" name="hewan" placeholder="Kegunaan Hewan">
        </div>
        @error('hewan')
            <small style="color: red">{{ $message }}</small>
        @enderror
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="lahir" placeholder="Ditanam" id="d1" onchange="calculateDays()">
        </div>
        @error('lahir')
            <small style="color: red">{{ $message }}</small>
        @enderror
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="mati" placeholder="Mati" id="mati">
        </div>
        @error('mati')
            <small style="color: red">{{ $message }}</small>
        @enderror
