...
<div class="container">
    ...
    <form action="{{ route('tani.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
           <label for="">Kegunaan Tanaman</label>
            <input type="text" class="form-control" name="tanaman" placeholder="Kegunaan Tanaman">
        </div>
        @error('tanaman')
            <small style="color: red">{{ $message }}</small>
        @enderror
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="ditanam" placeholder="Ditanam" id="d1" onchange="calculateDays()">
        </div>
        @error('ditanam')
            <small style="color: red">{{ $message }}</small>
        @enderror
        ...
        <div class="form-group input-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control" name="umur" id="output" readonly="">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="dipanen" placeholder="Dipanen" id="dipanen">
        </div>
        @error('dipanen')
            <small style="color: red">{{ $message }}</small>
        @enderror
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control ckeditor" id="content" name="hasil" placeholder="Hasil"></textarea>
        </div>
        @error('hasil')
            <small style="color: red">{{ $message }}</small>
        @enderror
