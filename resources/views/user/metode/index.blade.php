...
@section('content')
<div class="container">
    <a href="/metode/create" class="btn btn-primary mb-3">Tambah Data</a>
        ...
        <table class="table table-hover table-stripped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $metode->user }}</td>
                    <td>
                        <a href="{{ route('metode.edit', $metode->id) }}" class="btn btn-warning btn-sm text-white">Edit</a>
                        <form method="POST" action="{{ route('metode.destroy', $metode->id )}}">
                        @method('DELETE')
                        @csrf    
