...
@section('content')
<div class="container">
    <a href="/jenisternak/create" class="btn btn-primary mb-3">Tambah Data</a>
    ...
    <div class="table-responsive my-3">
        <table class="table table-hover table-stripped">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $i++ }}</td>
                    <td>{{ $jenisternak->name }} </td>
                    <td>
                        <form method="POST" action="{{ route('jenisternak.destroy', $jenisternak->id )}}">
                        @method('DELETE')
                        @csrf    
